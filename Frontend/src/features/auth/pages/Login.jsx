...
const Login = () => {
  ...
  const handleSubmit = async (e) => {
    ...
    setTimeout(() => {
      setIsLoading(false);
      // Reset form or handle navigation here
    }, 1200);
  };
    ...
    <div className="min-h-screen bg-slate-950 flex items-center justify-center p-4 relative overflow-hidden font-sans">
      ...
      <div className="w-full max-w-md bg-slate-900/60 backdrop-blur-xl border border-slate-800/80 p-8 rounded-2xl shadow-2xl relative overflow-hidden transition-all duration-300 hover:shadow-primary/5 hover:border-primary/30">
        ...
        <form onSubmit={handleSubmit} className="space-y-6">
          ...
          <div>
            <div className="flex justify-between items-center mb-2">
              ...
              <a href="#" className="text-xs text-primary hover:text-primary-hover transition-colors duration-200">
                Forgot password?
              </a>
            </div>
            <div className="relative group">
        ...
        <p className="text-sm text-slate-400 text-center mt-8">
          ...
          <Link to="/register" className="text-primary hover:text-primary-hover font-semibold transition-colors duration-200 ml-1 underline underline-offset-4 decoration-primary/30 hover:decoration-primary-hover">
            Sign up
          </Link>
        </p>
